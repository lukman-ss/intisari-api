...
class AuthLogoutTest extends TestCase
{
    ...
    public function test_it_logs_out_successfully_and_invalidates_token(): void
    {
        ...
        $request = new Request('POST', '/api/auth/logout', [], [], $headers, '');
        ...
        $this->assertSame('Logged out', $body['message']);
        $this->assertEmpty($body['data']);
        
        // Attempt to use token again
        $request2 = new Request('GET', '/api/auth/me', [], [], $headers, '');
